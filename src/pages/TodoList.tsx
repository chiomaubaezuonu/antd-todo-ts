...
const TodoList = () => {
  ...
  const [countChecked, setCountChecked] = useState<number>(() => {
    const stored = localStorage.getItem("countChecked");
  ...
  useEffect(() => {
    localStorage.setItem("countChecked", JSON.stringify(countChecked));
  }, [countChecked]);
    ...
    <Row>
      {!todoPage && taskList.length === 0 ? (
        <Col span={24} className="noTask-wrapper">
          ...
          <Title className="homePage-title">
            No task yet!! Please add a task
          </Title>
          <Col>
        ...
        <Col span={24} className="todoPage-container">
          ...
          <Col className="todoList">
            <Col className="progressBar">
              <Title level={2} id="taskList-title">
                Task List
              </Title>
              <Col>
                ...
                <div style={{ width: 170 }}>
                  <Col>
                    {countChecked}/ {taskList.length} tasks left
                  </Col>
            ...
            <Col className="todo-btns">
              ...
              >
                <Option key="allTask" value="">
                  {" "}
                  All Tasks
                </Option>
                <Option key="completedTasks" value="Completed Tasks">
                  {" "}
                  Completed Tasks
                </Option>
                ...
                return (
                  <Col key={item.id}>
                    <Col
                      ...
                      style={{
                        color: item.isDone ? "gray" : "",
                        opacity: item.isDone ? "0.7" : "",
                      }}
                    >
                      <Col className="todos">
                        <Checkbox
                      ...
                      >
                        <Option key="completedTasks" value="completedTasks">
                          Due Date
                        </Option>
